...
public:
  ...
  void post(const std::string& url, const http::body_type& body, long& response_code,
            std::string& response_content) const {
    curl_easy_setopt(_curl, CURLOPT_URL, url.c_str());
  ...
  void put(const std::string& url, const http::body_type& body, long& response_code,
           std::string& response_content) const {
  ...
  void del(const std::string& url, long& response_code, std::string& response_content) {
...
http::response client::del(const std::string& path) const {
  ...
  curl.del(url, response_code, response_content);
  return http::response{static_cast<http::codes>(response_code), response_content};
}
