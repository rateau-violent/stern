...
namespace network {
    ...
    void tcp_connection::_handle_response() {
    ...
    void tcp_connection::_handle_request(const std::error_code& error_code, std::size_t bytes_read) {
        std::string data{
            std::istreambuf_iterator<char>(&_request),
